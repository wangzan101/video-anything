...
> **历史文档提示（2026-07-24）**：下载部分的现行契约、退出码、宿主矩阵和发布语义以 [2026-07-24-video-download-contract.md](2026-07-24-video-download-contract.md) 为准。本文件的“可发”、Tier-1 和平台成功标准不是当前 release 证据。
